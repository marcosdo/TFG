...
static esp_err_t index_handler(httpd_req_t *req) {
  ...
  if (s != NULL) {
    if (s->id.PID == OV3660_PID) {
      return 0; //httpd_resp_send(req, (const char *)index_ov3660_html_gz, index_ov3660_html_gz_len);
    } else if (s->id.PID == OV5640_PID) {
      return 0; //httpd_resp_send(req, (const char *)index_ov5640_html_gz, index_ov5640_html_gz_len);
    } else {
