...
// ===========================
/*
 * This example is deprecated as only works on 
 * ESP32 v.1.0.6 or earlier. Library funcions have been 
 * improved since this version and most of the ones
 * used in this example die out
 */
